...
#ifndef anvirt_vm_proc_def_h
#define anvirt_vm_proc_def_h

// ANV_VMPROC_DLL should define if build shared lib on windows.
#if defined(ANV_VMPROC_DLL)
// WAVEFORMCODEC_CORE should define in core src
#if defined(ANV_VMPROC_CORE)
#define ANV_VMPROC_API __declspec(dllexport)
#else
#define ANV_VMPROC_API __declspec(dllimport)
#endif
#else
#define ANV_VMPROC_API extern __attribute__((visibility("default")))
#endif
