...
ANV_VMPROC_API anv_i32 anv_log_init(const char *config_file);
#ifdef __GOLANG_LOG__
ANV_VMPROC_API void anv_log_log(anv_i32 level, char *tag, char *msg);
#else
ANV_VMPROC_API void anv_log_log(anv_i32 level, const char *tag, const char *msg);
#endif

ANV_VMPROC_API void anv_log_log_in(anv_i32 level, const char *tag, const char *fmt, ...);
